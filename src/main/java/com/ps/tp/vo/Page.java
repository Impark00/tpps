...
public class Page { //페이징 관련 클래스
	...
	private int postNum = 10; //한 페이지에 출력할 게시물의 개수
	private int pageNum; //하단 페이징 번호([게시물 총개수 / 한페이지에 출력할 개수]의 올림)
	private int displayPost; //출력할 게시물
	private int pageNumCnt = 10; //한번에 표시할 페이징 번호의 개수
	private int endPageNum; //표시되는 페이지 번호중 마지막 번호
	private int startPageNum; //표시되는 페이지 번호중 첫 번째 번호
	...
	private void dataCalc() { //데이터를 계산하는 메서드
		//마지막 번호
